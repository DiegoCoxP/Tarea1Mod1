...
<section class="px-5 py-5">
	<div class="container">
		...
		<form action="add" method="post" class="needs-validation" novalidate>
			...
			<div class="form-group">
				<label for="numPaginas" class="form-label">N· Paginas</label>
			...
			<div class="form-group">
				<label for="tipoPasta" class="form-label">TipoPasta</label>
			...
			<div class="form-group py-3" style="text-align: right;">		
				...
				<button class="btn btn-primary" type="button" onclick="window.location.href='/ismac-libreria-web-online/libros/findAll'; return false;">
